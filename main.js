...
loader.load('https://eoimages.gsfc.nasa.gov/images/imagerecords/57000/57735/land_ocean_ice_cloud_2048.jpg', (texture) => {
  // create the sphere
...
const lastMove = [window.innerWidth / 2, window.innerHeight / 2];
